...
new #[Layout('layouts.admin')] #[Title('Daftar Bank')] class extends Component {
    use WithPagination;
                    ...
                    @foreach ($this->banks as $no => $bank)
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="extra-small text-muted">{{ $bank->bank_code }}</div>
                            </td>
                            ...
                            <td class="text-center text-uppercase">
                                <span
                                    class="badge bg-light text-dark border extra-small">{{ $bank->method ?: '-' }}</span>
                            </td>
                            <td class="text-center">
