    ...
    <div class="card card-dashboard border-0">
        <div class="card-body border-bottom">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h5 class="fw-bold mb-1">Tambah Halaman Baru</h5>
                    <p class="text-muted small mb-0">Buat halaman statis baru untuk website.</p>
                </div>
                ...
                <div class="row g-4">
                    <div class="col-md-7">
                        ...
                        <input type="text" class="form-control py-2 @error('title') is-invalid @enderror"
                            wire:model.live.debounce.300ms="title" id="title" placeholder="Contoh: Tentang Kami">
                        @error('title')
                    ...
                    <div class="col-md-5">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text"
                                ...
                                wire:model="slug" id="slug" placeholder="tentang-kami">
                        </div>
                        @error('slug')
                ...
                <div class="d-flex justify-content-end gap-2 border-top pt-4 mt-5">
                    ...
                    <button class="btn btn-primary text-white fw-bold px-4 shadow-sm" wire:loading.attr="disabled">
                        <span wire:loading.remove>
                            Simpan Halaman <i class="bi bi-floppy-fill ms-2"></i>
                        </span>
                        <span wire:loading>
