                ...
                <div class="mb-3">
                    ...
                    <div class="input-group bg-light rounded-3 overflow-hidden border-0">
                        ...
                        <input type="text" wire:model="name"
                            class="form-control py-3 bg-transparent border-0 shadow-none <?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div class="text-center mt-4">
                <p class="text-muted small">
                    Sudah punya akun? <a href="<?php echo e(route('login')); ?>" wire:navigate
...
</div><?php /**PATH C:\laragon\www\inisiatif\storage\framework/views/livewire/views/95d57ed1.blade.php ENDPATH**/ ?>