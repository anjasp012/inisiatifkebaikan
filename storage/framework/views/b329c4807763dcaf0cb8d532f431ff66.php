                ...
                <div class="search-overlay" :class="{ 'active': searchOpen }">
                    <div class="container-fluid search-container">
                        <div class="search-header">
                            <h3>Cari Program</h3>
                            <button class="btn btn-secondary btn-close-search" @click="searchOpen = false">
...
<?php /**PATH C:\laragon\www\inisiatif\resources\views/components/app/navbar.blade.php ENDPATH**/ ?>