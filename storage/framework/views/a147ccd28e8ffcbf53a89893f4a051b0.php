...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($campaign): ?>
    <div class="priority-card card border-0 rounded-2 overflow-hidden shadow-sm" style="background-color: #F0F9FF;">
        <div class="position-relative">
            <img src="<?php echo e($campaign->thumbnail_url); ?>" class="w-100 object-fit-cover" style="aspect-ratio: 19/10;"
        ...
        <div class="card-body p-3">
            ...
            <h6 class="fw-bold text-dark font-jakarta mb-2" style="line-height: 1.4; font-size: 15px;">
                <a href="<?php echo e(route('campaign.show', $campaign->slug)); ?>" wire:navigate
                    class="text-decoration-none text-dark">
                    <?php echo e(Str::limit($campaign->title, 55)); ?>

                </a>
            </h6>

            <p class="text-muted small mb-3" style="line-height: 1.5; font-size: 11px;">
                <?php echo e(Str::limit($campaign->description, 75)); ?>
            ...
            <div class="row g-2 mb-3">
                <div class="col-6">
                    <div class="bg-white p-2 rounded-3 h-100 border-0 shadow-sm text-center">
                        <div class="fw-bold" style="font-size: 13px; color: #D95D0F;">
                            Rp <?php echo e(number_format($campaign->collected_amount / 1000000, 1, ',', '.')); ?>M
                        </div>
                ...
                <div class="col-6">
                    <div class="bg-white p-2 rounded-3 h-100 border-0 shadow-sm text-center">
                        <div class="fw-bold" style="font-size: 13px; color: #D95D0F;"><?php echo e($donorCount); ?></div>
...
<?php /**PATH C:\laragon\www\inisiatif\resources\views/components/app/priority-card.blade.php ENDPATH**/ ?>