...
// Espay Callbacks
Route::post('/espay/inquiry', [App\Http\Controllers\EspayCallbackController::class, 'inquiry']);
Route::post('/espay/payment', [App\Http\Controllers\EspayCallbackController::class, 'payment']);
